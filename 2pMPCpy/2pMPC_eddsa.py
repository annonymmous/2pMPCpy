...
ckey1 = encrypt(pllr_pub_1, a1) 
print("ckey1 = ", ckey1)


'''  ckey2 stays a scalar. Therefore, no encrypt  '''
ckey2 = e_add_const(pllr_pub_1, ckey1, a2)
print("ckey2 = ", ckey2)

''' '''
ckey3 = e_mul_const(pllr_pub_1, ckey2, h) #  h * (encrypt(a1) + a2)
print("ckey3 = ", ckey3)

''' '''
ckey4 = r 
ckey4 = encrypt(pllr_pub_1, r)
print("ckey4 = ", ckey4)

ciphertext = e_add(pllr_pub_1, ckey4, ckey3)
